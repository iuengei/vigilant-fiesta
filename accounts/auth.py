...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    teacher_info = models.OneToOneField('accounts.Teacher', null=True, blank=True,
                                        related_name='user_info', verbose_name='关联教师')
    supervisor_info = models.OneToOneField('accounts.Supervisor', null=True, blank=True,
    ...
    @staticmethod
    @receiver(post_save, sender='accounts.Teacher')
    ...
    @staticmethod
    @receiver(post_save, sender='accounts.Supervisor')
